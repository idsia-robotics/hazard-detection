...
class LinearRNVP(nn.Module):
    ...
    def __init__(self,
        ...
        if mask_type == 'odds':
            ...
            assert False, "Mask type indicated is not accepted"

        # this is wrong wrt RNVP paper. the hidden layers should always have a higher or equal size wrt the input dim
    ...
    def prior(self):
        ...
        return distributions.MultivariateNormal(self.prior_mean, self.prior_var)
